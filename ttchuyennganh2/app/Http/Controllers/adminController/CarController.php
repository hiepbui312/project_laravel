...
use App\Models\adminModels\CarModel as MainModel;
use Session;
class CarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.carView',["data"=>$data]);
    }
    public function create(){
        return view('admin.carFormView');
    }
    public function createPost(Request $request){
        ...
        if($request->hasFile('image')){
            ...
            if ($validator->fails()) {
                ...
                return redirect('admin/product/car/addCar')->withErrors($validator)->withInput();
            } else {
                ...
                { 
                    ...
                    $insertImages = DB::insert('insert into car_images (name,car_id) values (?,?)', [$getImage,$getId]);
                } 
            }
        }
        //di chuyen den url
    ...
    public function edit($id){
        ...
        return view('admin.carFormView',['record'=>$record,"image"=>$image]);
    }
    ...
    public function editPost($id,Request $request){
        ...
        if($request->hasFile('image')){
            ...
            if ($validator->fails()) {
                // Điều kiện dữ liệu không hợp lệ sẽ chuyển về trang đăng nhập và thông báo lỗi
                return redirect('admin/product/car/editCar/'.$id)->withErrors($validator)->withInput();
            } else {
    	...
    	//di chuyen den url: /admin/product/car
    	return redirect("admin/product/car");
    }
    ...
    public function carDetail($id){
        ...
        $image = $this->model->getImage($id);
        return view('admin.carDetailView',["data"=>$data,"image"=>$image]);
    }
}